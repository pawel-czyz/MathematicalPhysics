...
Consider a sentence\commentforexperts{In fact we are dealing with a set of sentences.} $P(n)$ involving an object $n$ (for example $n$ can be an integer and $P(n)$ can be a sentence "$n=2n$").
\begin{definition}
