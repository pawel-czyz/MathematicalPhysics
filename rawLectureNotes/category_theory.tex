...
This "equivalence" structure will be used to idenfify some spaces. Note that if it has properties of an equivalence relation, a relation on a \emph{set} $A$ is a subset of $A\times A$. As we are
